...
void MenuCtl::menuPrincipal(){
    ...
    std::cout << "\tC: Seleccion de camaras" << std::endl;
...
void MenuCtl::selCamara(int nCam){
    std::cout << "Modo seleccion de iluminacion:" << std::endl;

    for(int i = 0; i < nCam; i++)
        std::cout << "\t" << i << " : Activar camara " << i << std::endl;
}

void MenuCtl::seleccionadaCamara(int i){
    std::cout << "\nSeleccionada camara: " << i << std::endl;
}

void MenuCtl::seleccionadoObjeto(int i){
    std::cout << "\nSeleccionado objeto: " << i << std::endl;
}