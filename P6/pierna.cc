...
void Pierna::draw(bool modoSeleccion){
    translacion = {0.0, 0.0, 0.0};
    escala = {0.0, 0.0, 0.0};
    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                unionPie->draw(modoSeleccion);
            glPopMatrix();
            // Pie
            glPushMatrix();
                pie->draw(modoSeleccion);
            glPopMatrix();
        glPopMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                unionCuadriceps->draw(modoSeleccion);
            glPopMatrix();
            // Cuadriceps
            glPushMatrix();
                if(tipo == TipoExtremidad::DCHA)
...
void Pierna::setColorModoSelec(Tupla3f color){
    pie->setColorModoSelec(color);
    cuadriceps->setColorModoSelec(color);
    unionPie->setColorModoSelec(color);
    unionCuadriceps->setColorModoSelec(color);
}

void Pierna::setSeleccionado(bool valor){
    pie->setSeleccionado(valor);
    cuadriceps->setSeleccionado(valor);
    unionPie->setSeleccionado(valor);
    unionCuadriceps->setSeleccionado(valor);
}

void Pierna::setMaterial(Material mat){
    pie->setMaterial(mat);
    cuadriceps->setMaterial(mat);
    unionPie->setMaterial(mat);
    unionCuadriceps->setMaterial(mat);
}