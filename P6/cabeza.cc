...
void Cabeza::draw(bool modoSeleccion){
    translacion = {0.0, 0.0, 0.0};
    escala = {0.0, 0.0, 0.0};
    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                unionCabeza->draw(modoSeleccion);
            glPopMatrix();
            // Cabeza
            glPushMatrix();
...
void Cabeza::setColorModoSelec(Tupla3f color){
    cabeza->setColorModoSelec(color);
    cuello->setColorModoSelec(color);
    unionCabeza->setColorModoSelec(color);
}

void Cabeza::setSeleccionado(bool valor){
    cabeza->setSeleccionado(valor);
    cuello->setSeleccionado(valor);
    unionCabeza->setSeleccionado(valor);
}

void Cabeza::setMaterial(Material mat){
    cabeza->setMaterial(mat);
    cuello->setMaterial(mat);
    unionCabeza->setMaterial(mat);
}